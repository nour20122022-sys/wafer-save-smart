...
-- Enable realtime for challenges and achievements
ALTER PUBLICATION supabase_realtime ADD TABLE public.user_challenges;
ALTER PUBLICATION supabase_realtime ADD TABLE public.achievements;

-- Function to auto-grant achievements on challenge completion milestones
...
BEGIN
  ...
  IF NEW.status = 'completed' AND (OLD.status IS NULL OR OLD.status <> 'completed') THEN
    ...
    -- Grant achievement if milestone hit
